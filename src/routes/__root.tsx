  ...
  head: () => ({
    meta: [
      ...
      { title: "Game Night — Play board games with friends & family" },
      {
        name: "description",
        content:
          "A cozy online board game hub. Create a room, share the code, and play board games with friends and family — live, in real time.",
      },
      { name: "author", content: "Game Night" },
